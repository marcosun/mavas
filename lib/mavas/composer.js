      ...
      if (data[0] instanceof Array) {
        ...
        for(let i = 0, len = data.length; i < len; i++) {
          result.push({
            ...
            symbol: data[i].symbol ? this.symbolReducer(data[i].symbol) : options.symbol,
            lineStyle: data[i].lineStyle ? this.lineStyleReducer(data[i].lineStyle) : options.lineStyle,
          });
        };
