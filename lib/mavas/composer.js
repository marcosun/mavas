...
export default class Composer extends Component {
      ...
      case 'quadraticCurve':
        ...
        */
        ...
        options = Object.assign({},
          options,
          {
            data: this.dataReducer(outerOptions.data, options.lineStyle),
          },
        );
  ...
  */
  ...
  dataReducer(data, lineStyle) {
    const defaultEmptyConfig = [],
          defaultNoneEmptyConfig = [{
            coords: [],
            lineStyle: {},
          }];
      ...
      if (data[0] instanceof Array) {
        ...
        for(let i = 0, len = data.length; i < len; i++) {
          result.push({
            ...
            lineStyle: data[i].lineStyle ? this.lineStyleReducer(data[i].lineStyle) : lineStyle,
          });
        };
