  ...
  const saveMarkers = (data) => {
    ...
    for(let i = 0, len = data.length; i < len; i ++) {
      ...
      if (userDefinedIcon) {
        ...
        offsetX = data[i].offsetX - userDefinedIcon.width / 2;
        offsetY = data[i].offsetY + userDefinedIcon.height / 2;
      } else {
        //reposition default marker
        offsetX = - defaultMarker.width / 2;
        offsetY = defaultMarker.height;
