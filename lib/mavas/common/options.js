  ...
  case 'tooltip':
    ...
    */
    options = {
      ...
      id: outerOptions.id,
      data: {
        coords: outerOptions.data && outerOptions.data.coords instanceof Array ? outerOptions.data.coords : [],
        size: outerOptions.data && outerOptions.data.size instanceof Array ? outerOptions.data.size : [],
    ...
    if (options.data.coords.length !== options.data.size.length || options.data.coords.length !== options.data.desc.length) {
      throw new Error('number of coords, size, and desc must be identical');
    }
